...
async def chat_with_pdf(request: PDFChatRequest):
    ...
    try:
        ...
        user_prompt = (
            ...
            "- The deterministic calculator output supplied in the context is the absolute single source of truth.\n"
            "- If the user asks you to recalculate compensation, apply different multiplier figures, or alter prospects, explicitly instruct them to update the workstation parameters in the left-hand panel, as the mathematical engine remains the ultimate source of truth.\n\n"
            f"Context:\n{chunks_combined}\n\n"
            f"Question:\n{question_str}"
        )
